	...
	for (int i = 0; i < 15; i++)//每一列
	{
		for (int j = 0; j < 15; j++)//每一行
		{
			if (map[i][j] != 0)//以一个棋子为中心发散判断，遇到空或其他颜色的棋子跳出
			{
				...
				else if (map[i][j] == 2)sum_crossing = sum_crossing - x*2;
			}
		}
	...
	for (int i = 0; i < 15; i++)//每一列
	{
		for (int j = 0; j < 15; j++)//每一行
		{
			if (map[i][j] != 0)//以一个棋子为中心发散判断，遇到空或其他颜色的棋子跳出
			{
				...
				else if (map[i][j] == 2)sum_lenthways = sum_lenthways - x * 2;
			}
		}
	...
	for (int i = 0; i < 15; i++)//每一列
	{
		for (int j = 0; j < 15; j++)//每一行
		{
			if (map[i][j] != 0)//以一个棋子为中心发散判断，遇到空或其他颜色的棋子跳出
			{
				...
				else if (map[i][j] == 2)sum_leftline = sum_leftline - x * 2;
			}
		}
	}
	return sum_leftline;
	...
	for (int i = 0; i < 15; i++)//每一列
	{
		for (int j = 0; j < 15; j++)//每一行
		{
			if (map[i][j] != 0)//以一个棋子为中心发散判断，遇到空或其他颜色的棋子跳出
			{
				...
				else if (map[i][j] == 2)sum_rightline = sum_rightline - x * 2;
			}
		}
